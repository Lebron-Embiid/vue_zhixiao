<template>
	<div class="pageClass">
		<div class="letter_content">
			<table>
				<th>
					<td width="400">分类编码</td>
					<td width="400">分类名称</td>
					<td width="400">分类排序</td>
					<td width="400">分类操作</td>
				</th>
				<tr v-for="(item,index) in tableData" :key="index">
					<td width="400">{{item.id}}</td>
					<td width="400"><input type="text" v-model="item.name"></td>
					<td width="400"><input type="text" v-model="item.rank"></td>
					<td width="400">
