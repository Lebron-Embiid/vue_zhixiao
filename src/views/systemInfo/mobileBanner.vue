		...
		<el-form ref="form" class="form_box" :model="form">
			<div class="form_item">
				...
				<div class="el-upload-box">
					<upload-img :productImgs="mobileBannerList"></upload-img>
				</div>
				<p class="right_till">该上传为批量上传，每张不超过200KB11 (宽：500 高：200)</p>
			</div>
			<div class="form_item">
				<span class="left_txt">链接添加-修改后点击提交保存</span>
				<table>
					<th>
						<td width="80">位置</td>
						<td width="300">链接</td>
					...
					<tr v-for="(item,index) in tableData" :key="index">
						<td width="80">{{item.index}}</td>
						<td width="300"><input type="text" v-model="item.link"></td>
					</tr>
				</table>
			</div>
